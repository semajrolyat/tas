...
int log_c::get_fd( void ) { return fd; }
//-----------------------------------------------------------------------------
bool log_c::get_opened( void ) { return opened; }
//-----------------------------------------------------------------------------
log_channel_e log_c::get_channel( void ) { return channel; }
...
log_c::log_c( const std::string& filename ) {
  opened = false;
...
log_c::log_c( const log_channel_e& channel ) {
...
log_err_e log_c::write( const std::string& s ) {
  assert( opened );
...
/// descriptor
log_err_e log_c::writeln( const std::string& s ) {
