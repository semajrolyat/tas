...
public:
  ...
  //actuator_c actuator;
  sensor_c sensor_predator;
  sensor_c sensor_prey;
  ...
  sensor_c pred_sensor, prey_sensor;
...
protected:
 #if defined(GAZEBO_DYNAMICS)  // When running the ship as a gazebo plugin
  //---------------------------------------------------------------------------
  ...
  void sense( pp_state_c& q );

  // handles any planning for a given time step
  virtual bool plan( void );
  bool plan( const pp_state_c& q, ship_command_c& u );

  // handles any acting behavior for a given time step
  virtual void act( void );
  void act( const pp_state_c& q, const ship_command_c& u );
  ...
  ship_command_c compute_feedback( const ship_state_c& q, ship_command_c& u );
